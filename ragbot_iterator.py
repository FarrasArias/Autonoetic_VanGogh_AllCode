...
def main():
    ...
    for question in questions:
        ...
        #Make a dataframe, merge it with the other df. Add scores, select the three most important, put them in context.
        ...
        q_a.append((user["content"], chatbot, context["content"]))
    
        df_5 = pd.DataFrame(q_a, columns=["Question", "Answer", "Context"])
        df_5.to_csv("q_a_c_davinci.csv")
