...
class RAG:
    ...
    def similarity_search(self, query, n_results=5, return_indexes=False, from_chat=False):
        ...
        """
        #print(Fore.BLUE+str(from_chat)+"2"+Fore.RESET)
        distances, results = self.encoder.similarity_search(query, n_results, return_indexes, from_chat=from_chat)
